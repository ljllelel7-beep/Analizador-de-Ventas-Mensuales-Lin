...
def best_selling_day(data):
    ...
    for day in data: 
        ...
        if  total_sales > highest_total:
            highest_total = total_sales  
            best_day = (day["day"])

    return best_day, highest_total
...
def top_product(data):
    ...
    for day in data:
        total_a = total_a + (day["product_a"])
        total_b = total_b + (day["product_b"])
        total_c = total_c + (day["product_c"] )

    if total_a > total_b and total_a > total_c:
        return "product_a", total_a
    elif total_b > total_a and total_b > total_c:
        return "product_b", total_b
    else:
        return "product_c", total_c
